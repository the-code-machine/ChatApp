...
function Chat({ socket, username, room }) {
  ...
  return (
    <div className="lg:w-1/2 lg:h-3/4 w-full h-screen flex flex-col p-2 shadow-2xl bg-[#f7a8c4] justify-between lg:rounded-3xl">
      <div className="w-1/3 h-10 rounded-full font-semibold flex justify-center items-center p-3 bg-white">
        <p>Live Chat</p>
      </div>
      <div className="h-3/4 p-3 flex flex-col mt-2 border-t-2 border-white">
        <div
          className="flex flex-col h-[60vh] scroll-bar overflow-y-auto"
      ...
      <div className="w-full p-3 flex items-center justify-between">
        ...
        {/* Button to open file input for image selection */}
        <button
          onClick={() => {
